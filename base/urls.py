...
urlpatterns = [
    ...
    path('user_panel', user.userPanel, name = 'user-panel'),
    path('change_email', user.changeEmail, name = 'change-email'),
    path('change-password', user.changePassword, name = 'change-password'),
