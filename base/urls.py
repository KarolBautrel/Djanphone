...
urlpatterns = [
    ...
    path('remove_from_cart/<slug>',
         online_shop.removeFromCart, name='remove-from-cart'),
    ...
    path('delete_comment/<int:pk>',
         online_shop.deleteComment, name='delete-comment'),
    path('order_summary/', login_required(OrderSummaryView.as_view(),
                                          login_url='/accounts/login/'), name='order-summary'),
    path('add_coupon/', login_required(AddCouponView.as_view(),
         login_url='/accounts/login/'), name='add-coupon'),
    path('checkout/shipping', login_required(CheckoutShippingView.as_view(),
         login_url='/accounts/login/'), name='shipping'),
    path('checkout/billing', login_required(CheckoutBillingView.as_view(),
         login_url='/accounts/login/'), name='billing'),
    path('checkout/paypal/', login_required(PaymentPaypalView.as_view(),
         login_url='/accounts/login/'), name='paypal'),
    path('complete', login_required(PaymentSuccessView.as_view(),
         login_url='/accounts/login/'), name='payment-succes'),
    path('account_settings/', user.settingsPanel, name='account-settings'),
    path('account_settings/<int:pk>/profile/',
    ...
    path('account_settings/change_email',
         user.changeEmail, name='change-email'),
    path('account_settings/change-password',
         user.changePassword, name='change-password'),
    ...
    path('ticket_panel/<int:pk>',
         communication_user.ticketPanel, name='ticket-panel'),
    ...
    path('modify_store_product/<int:pk>',
         local_stores.modifyStoreProducts, name='modify-product-store'),
    path('superuser_panel', superuser_panel.adminPanel, name='superuser'),
    path('superuser_panel/message',
         SendMessageCreationView.as_view(), name='message'),
    path('superuser_panel/createProduct',
         ProductCreateView.as_view(), name='create-product'),
]
